...
public class LoadingTableViewDataSelectedRowName {
    ...
    public static boolean Welcome(String query, Pane viewTablePane) throws Exception {
    ...
    public static boolean Welcome(String query, Pane viewTablePane, double height, double width) throws Exception {
        ObservableList<ObservableList> data;
        tableView = new TableView();
        tableView.setEditable(true);
